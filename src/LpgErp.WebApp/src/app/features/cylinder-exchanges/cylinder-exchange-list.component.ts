...
export class CylinderExchangeListComponent {
  readonly config: EntityConfig = {
    ...
    fields: [
      ...
      { key: 'incomingBrandId', label: 'Incoming Brand', type: 'select', endpoint: 'brands', optionLabel: 'name' },
      { key: 'incomingCylinderSizeId', label: 'Incoming Cylinder Size', type: 'select', endpoint: 'cylindersizes', optionLabel: 'name' },
      { key: 'incomingQuantity', label: 'Incoming Quantity', type: 'number' },
      { key: 'outgoingBrandId', label: 'Outgoing Brand', type: 'select', endpoint: 'brands', optionLabel: 'name' },
      { key: 'outgoingCylinderSizeId', label: 'Outgoing Cylinder Size', type: 'select', endpoint: 'cylindersizes', optionLabel: 'name' },
